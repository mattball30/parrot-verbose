...
def main(parser_args, debug=False):
    ...
    if testset_args["testset_distinguish_catalyst"]:
        ...
        pred_conditions, pred_temperatures, topk_acc_df_catalyst_na = (
            model.condition_beam_search(
                test_df_catalsyt_na,
                output_dir=model_args["best_model_dir"],
                beam={0: 1, 1: 3, 2: 1, 3: 5, 4: 1},
                test_batch_size=8,
        ...
        pred_conditions, pred_temperatures, topk_acc_df_catalyst_have = (
            model.condition_beam_search(
                test_df_catalsyt_have,
                output_dir=model_args["best_model_dir"],
                beam={0: 2, 1: 3, 2: 1, 3: 3, 4: 1},
                test_batch_size=8,
                calculate_topk_accuracy=True,
        ...
        pred_conditions, pred_temperatures, topk_acc_df = model.condition_beam_search(
            ...
            verbose_output=parser_args.verbose_output,
        )
        print(topk_acc_df)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--verbose_output",
        action="store_true",
        help="Output the verbose results",
    )
